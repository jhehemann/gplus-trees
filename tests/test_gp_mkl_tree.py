...
# Create factory function for Merkle GPlus-trees
def create_merkle_gplustree(K: int) -> MerkleGPlusTreeBase:
    """Create a new Merkle-enabled GPlus-tree with capacity K"""
    from gplus_trees.factory import make_gplustree_classes
    
    # Get the standard classes
    ...
    MerkleGPlusNodeK = type(
        ...
        {
            "SetClass": KListK,
            "TreeClass": None,  # Will be set later
...
class TestMerkleGPlusTreeSpecialCases(TestMerkleGPlusTree):
    ...
    def test_different_capacity_trees(self):
        """Test trees with different capacities have different hashes for same content"""
